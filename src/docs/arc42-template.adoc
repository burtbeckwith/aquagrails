...
endifndef::env-github[]

// configure DE settings for asciidoc
include::config.adoc[]


include::chapter/about-arc42.adoc[]
...
<<<<
// Verweise + Literatur
include::chapter/appendix-references.adoc[]

<<<<
// Beispiele
include::chapter/appendix-examples.adoc[]

<<<<
// Contributing and Contributors
include::chapter/appendix-contributing.adoc[]

<<<<
// Approved Practitioner for arc42
include::chapter/appendix-practitioner.adoc[]
